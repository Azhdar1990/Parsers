...
def user_agent_usage(url):
    ...
    try:
        ...
        #time.sleep(2)
        #driver.implicitly_wait(2) в отличии от time.sleep(2) где сприкт жестко засыпает на 2 сек
        # driver.implicitly_wait(2) ждет отклика от сайта макс 2 сек. То есть если сайт ответит раньше
        # скрипт продолжится раньше
