...
async def get_page_data(session, page):
    ...
    url = f"https://public.trendyol.com/discovery-web-searchgw-service/v2/api/infinite-scroll/sr?wb=44%2C33%2C160%2C159%2C652%2C636%2C803%2C454&wg=1&wc=1172&pi={page}&storefrontId=1&culture=tr-TR&userGenderId=1&pId=aumZRaKGJ2&scoringAlgorithmId=2&categoryRelevancyEnabled=false&isLegalRequirementConfirmed=false&searchStrategyType=DEFAULT&productStampType=TypeA&searchTestTypeAbValue=B"
...
#                print(f"Ой {discountedPriceInfo} меньше 40%-тов ((")
    ...
    with open(f"dump_girl.json", "w", encoding='utf-8-sig') as file:
        json.dump(all_data, file, indent=4, ensure_ascii=False)

def main():
    asyncio.get_event_loop().run_until_complete(gather_data_girl())
